<div class="modal fade" id="changeAvatarModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
...
<!-- modal 3 -->
<div class="modal fade" id="changeMailModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
     aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="col-sm">
                    <div class="row mt-3 d-flex justify-content-start">
                        <button type="button" class="btn btn-info mx-2" data-toggle="modal"
                                data-target="#changeAvatarModal" style="width: 120px;">Zmień avatar
                        </button>
                        <button class="btn btn-info mx-2" data-toggle="modal" data-target="#changeNameModal"
                                style="width: 120px;">Zmień nazwę
                        </button>
                        <button class="btn btn-primary mx-2" data-toggle="modal" data-target="#changeMailModal"
                                style="width: 120px;">Zmień mail
                        </button>
                    </div>
                    <div class="row mt-3 d-flex justify-content-start">
                        <div class="mx-2" style="width: 120px;"><a href="" class="btn btn-primary w-100">Zmień hasło</a>
                        </div>
                        <div class="mx-2" style="width: 120px;"><a href="<?= ROOT_PATH ?>users/verify"
                                                                   class="btn btn-warning w-100">Zweryfikuj</a></div>
                        <div class="mx-2" style="width: 120px;"><a href="" class="btn btn-danger w-100">Usuń konto</a>
                        </div>
                    </div>
                </div>
            ...
            <?php foreach ($viewmodel['activities'] as $activity): ?>
                <tr>
                    ...
                    <td><?= $activity['name'] . ' ' . $activity['action'] ?><a
                                href="<?= ROOT_PATH . 'memes/show/' . $activity['meme_id'] ?>">mema</a></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
...
<?php endif; ?>
    ...
    <div class="card text-center my-3 mx-5" style="max-width: 400px;">
        ...
        <div class="card-body">
            <a href="<?= ROOT_PATH ?>memes/show/<?= $meme['id'] ?>"><img class="card-img-top"
                                                                         src="<?= MEMES_ROOT_PATH . $meme['path'] ?>"
