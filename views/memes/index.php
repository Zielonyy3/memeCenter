...
<p class="lead text-center" style="font-size: 1.2rem;">Możesz dodawać swoje własne memy po <a href="<?=ROOT_PATH?>users/login">zalogowaniu!</a></p>
...
<?php endif; ?>
  ...
  <div class="card text-center my-3 mx-5" style="max-width: 400px;">
    ...
    <div class="card-body">
    <a href="<?=ROOT_PATH?>memes/show/<?=$row['id']?>"><img class="card-img-top" src="<?=MEMES_ROOT_PATH.$row['path']?>" alt="Card image cap"></a>
    </div>
    <div class="card-footer text-muted">
      <h5>Autor: <a href="<?=ROOT_PATH?>users/show/<?=$row['author_name']?>"><mark><?=$row['author_name']?></a></h5>
    </div>
